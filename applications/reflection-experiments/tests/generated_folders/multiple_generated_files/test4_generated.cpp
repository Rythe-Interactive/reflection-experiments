...
void register_reflection_file_test4()
{
    runtime_reflected_class class_7157684809129993704;
    class_7157684809129993704.name = rsl::dynamic_string::from_string_length("very_cool_target_class4");
    class_7157684809129993704.id = reflection_id(12671176660389978733ULL, 3676408051602900246ULL, 7157684809129993704ULL);
    class_7157684809129993704.type_spelling = rsl::dynamic_string::from_string_length("very_cool_target_class4");
    ...
    class_7157684809129993704.add_variable(std::move(variable_6501503083828029313));
    ...
    class_7157684809129993704.add_variable(std::move(variable_126163732700301715));
    ...
    class_7157684809129993704.add_variable(std::move(variable_17337086075296791468));
    ...
    class_7157684809129993704.add_function(std::move(function_11759744666720004420));

    runtime_reflected_class class_13701740648279338055;
    class_13701740648279338055.name = rsl::dynamic_string::from_string_length("nested_class4");
    class_13701740648279338055.id = reflection_id(4049501841743637870ULL, 7743830921338232219ULL, 13701740648279338055ULL);
    class_13701740648279338055.type_spelling = rsl::dynamic_string::from_string_length("nested_class4");
    ...
    class_13701740648279338055.add_variable(std::move(variable_9809713342160364025));
    ...
    class_13701740648279338055.add_function(std::move(function_8326206098713976876));
    ...
    class_13701740648279338055.add_function(std::move(function_3472948984907647894));
    ...
    class_13701740648279338055.add_function(std::move(function_15519012992129584017));

    class_7157684809129993704.add_class(std::move(class_13701740648279338055));

    reflection_context::instance().add_class(std::move(class_7157684809129993704));

    runtime_reflected_class class_14489458229511134429;
    class_14489458229511134429.name = rsl::dynamic_string::from_string_length("target_class4");
    class_14489458229511134429.id = reflection_id(12574702157244825494ULL, 529573297870223312ULL, 14489458229511134429ULL);
    class_14489458229511134429.type_spelling = rsl::dynamic_string::from_string_length("target_class4");
    ...
    class_14489458229511134429.add_variable(std::move(variable_13153249853553726320));
    ...
    class_14489458229511134429.add_variable(std::move(variable_6526241590453974317));
    ...
    class_14489458229511134429.add_function(std::move(function_14922869285292655127));

    reflection_context::instance().add_class(std::move(class_14489458229511134429));
...
struct reflection_file_registration_helper
{
    ...
    {
        reflection_registration_registry::instance().add(&register_reflection_file_test4);
    }
};
